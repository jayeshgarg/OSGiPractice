...
public class RestWeatherDisplayImpl implements RestWeatherDisplay
{
    ...
    {
        LOG.error("Request to fetch temperature details received");
    ...
    {
        LOG.error("Request to fetch humidity details received");
    ...
    @Override
    public Response postTemperature(String json)
    {
        String response = "{ \"result\" : \"Post request received well and responded well\" }";
